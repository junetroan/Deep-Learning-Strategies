...
@time begin
    for i in 1:iters
        ...
        CSV.write("Simulations/Results/sim-HL-ANODE-SS/Loss Data/Losses $i.csv", losses_df, writeheader = false)
        ...
        function plot_results(tp,tr, real, pred)
            ...
            savefig("Simulations/Results/sim-HL-ANODE-SS/Plots/Simulation $i.png")
        end
