...
#AutoVern7(KenCarp4(autodiff=true))
#AutoVern7()
#FBDF()
...
function plot_results(tp,tr, real, pred)
    ...
    plot!(tp, real, label = "Training Data")
    plot!(legend=:topleft)
    savefig("Results/HL/Training ANODE-MS II Model on Hare data - 75.png")
end
...
function plot_results(real_train, real_test, pred, pred_new)
    ...
    plot!(legend=:topright)
    savefig("Results/HL/Training and testing of ANODE-MS II Model on Hare and Lynx data - 75.png")
end
