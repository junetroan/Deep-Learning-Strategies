...
Simulation file for the Single Simulation of the NPEM Model on the Lotka-Volterra data
...
function plot_results(real, pred, pred_new)
    ...
    plot!(legend=:topright)
    savefig("sim-LV-NPEM/Plots/NPEM LV Training and Testing.png")
end

plot_results(Xₙ, full_traj, prediction_new)
