...
Simulation file for the Single Simulation of the ANODE-MS II Model on the Hare and Lynx data
...
CSV.write("sim-HL-ANODE-MS-II/Loss Data/Losses.csv", losses_df, writeheader = false)
...
function plot_results(tp,real, pred)
    ...
    plot!(legend=:topleft)
    savefig("sim-HL-ANODE-MS-II/Training ANODE-MS II Model on Hare data.png")
end
...
function plot_results(real_train, real_test, pred, pred_new)
    ...
    savefig("sim-HL-ANODE-MS-II/Training and testing of ANODE-MS II Model on Hare and Lynx data.png")
end
